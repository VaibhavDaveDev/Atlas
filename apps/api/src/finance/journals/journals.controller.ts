...
export class JournalsController {
  ...
  @Post()
  @RequirePermission({ resource: 'finance_journals', action: 'create', scope: 'all' })
  @ApiOperation({ summary: 'Create a new journal entry' })
  async create(@Body() createDto: CreateJournalEntryDto, @Req() req: Request): Promise<any> {
  ...
  @Get()
  @RequirePermission({ resource: 'finance_journals', action: 'read', scope: 'all' })
  ...
  @Delete(':id')
  @RequirePermission({ resource: 'finance_journals', action: 'delete', scope: 'all' })
