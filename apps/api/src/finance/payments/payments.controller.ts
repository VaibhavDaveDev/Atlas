...
export class PaymentsController {
  ...
  @Post()
  @RequirePermission({ resource: 'finance_payments', action: 'create', scope: 'all' })
  @ApiOperation({ summary: 'Create a new payment' })
  async create(@Body() createDto: CreatePaymentDto, @Req() req: Request): Promise<any> {
  ...
  @Get()
  @RequirePermission({ resource: 'finance_payments', action: 'read', scope: 'all' })
