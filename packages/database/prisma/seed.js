...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var defaultPassword, passwordHash, workspace, admin, hrManager, employee;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.authUser.upsert({
                ...
                case 3:
                    ...
                    return [4 /*yield*/, prisma.workspaceMember.upsert({
                            where: {
                ...
                case 8:
                    ...
                    console.log("Admin: admin@atlas.com / ".concat(defaultPassword));
                    console.log("HR: hr@atlas.com / ".concat(defaultPassword));
                    console.log("Employee: employee@atlas.com / ".concat(defaultPassword));
                    console.log('----------------------------------------------------');
                    return [2 /*return*/];
            }
        });
